...
//  displays are covered by the ward overlay itself, never left showing the live
//  desktop) and NO shader-style choice (the ward shader is always the sober
//  minimal glass). Gesture blocking IS user-controllable because gestures only
//  affect navigation, not content exposure.
